...
public class CallJavaIVR
{
	 ...
	 */
	  ...
	  */
	 public CallJavaIVR(String host, int port)
	 ...
	 {
		 CallJavaIVR obj = new CallJavaIVR();
		 obj.callIvr("0551633166", "SMSA", false);
		 String reqID = obj.callIvr("0551633166", "SMSA", false);
		 System.out.println(reqID);
		
		 /*
		 String mynumber = "1112222"; // replace with your own

		 CallJavaIVR voicent = new CallJavaIVR();
